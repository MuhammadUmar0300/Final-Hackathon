    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark sticky-top px-4 px-lg-5 py-3 py-lg-1">
            <Link to='home' className="navbar-brand p-0">
                <h1 className="text-primary m-0 navbar-brand-name">WillMart</h1>
            </Link>
            ...
            <div className="collapse navbar-collapse" id="navbarCollapse">
                <div className="navbar-nav ms-auto py-0 pe-4">
                    ...
                    <NavLink to='orders' className="nav-item nav-link" activeclassname="active" ><i class="bi bi-cart3"></i></NavLink>
