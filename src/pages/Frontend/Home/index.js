          ...
          <div className="container">
            <div className="row g-5 align-items-center">
              ...
              <div className="col-lg-6">
                ...
                <h1 className="mb-4 ">Welcome to <i className="fa fa-utensils text-primary me-2"></i><span className='about-name-project'>WillMart</span></h1>
              ...
              <div className=" testimonial-carousel w-50">
                <Carousel autoplay dotStyle={{ color: 'orange !important' }} activeDotStyle={{ color: 'red' }} >
                  <div className="testimonial-item bg-transparent border rounded p-4" style={{ width: '70%' }}>
                    ...
                    <p style={{ textAlign: "justify" }}>WillMart is a hidden gem! The menu is diverse, and every dish I tried was delicious. The staff is friendly, and the ambiance
                  ...
                  <div className="testimonial-item bg-transparent border rounded p-4">
                    <i className="fa fa-quote-left fa-2x text-primary mb-3"></i>
                    <p style={{ textAlign: "justify" }}>WillMart has nailed the balance between great food and outstanding service. Whether it’s a quick lunch or a formal dinner, they always deliver an amazing experience.
                  ...
                  <div className="testimonial-item bg-transparent border rounded p-4">
                    <i className="fa fa-quote-left fa-2x text-primary mb-3"></i>
                    <p style={{ textAlign: "justify" }}>I love how WillMart caters to various dietary needs without compromising on flavor. As a nutritionist, I appreciate the healthy options on the menu, and their salads are simply fantastic. Highly recommend for health-conscious diners!</p>
                    <div className="d-flex align-items-center">
