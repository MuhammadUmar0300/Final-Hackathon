...
import pastaImg from './../../../assets/pic/chef1.png'
...
export default function Landing() {
    ...
    return (
        <main className='landing'>
            <svg viewBox="0 0 500 150" preserveAspectRatio="none" className='wave-big-screen'><path d="M318.00,-2.44 C443.85,65.63 327.03,116.95 328.15,152.47 L500.00,150.00 L501.41,-5.41 Z" style={{ stroke: 'none', fill: '#2c87c6' }} ></path></svg>
            <svg viewBox="0 0 500 150" preserveAspectRatio="none" className='wave-small-screen'><path d="M-2.54,149.52 C66.87,139.64 192.71,-32.05 500.84,147.55 L500.00,0.00 L0.00,0.00 Z" style={{ stroke: 'none', fill: '#2c87c6' }}></path></svg>
            <div className="image-wrapper">
                <img src={pastaImg} alt="Pasta" className="pasta-img" />
            </div>
            <div className="row">
                <div className="col">
                    <h1 className='main-heading'><i className="fa fa-utensils text-primary me-3"></i>WillMart</h1>
